# ============================================================================ #
# GITHUB-PORTABLE COPY
# ECMT 674 Homework 4 - Apple Volatility Forecasting
#
# Changes from the submitted script:
#   1. Replaced the machine-specific APPL.xlsx path with data/APPL.xlsx
#   2. Removed install.packages() from the analysis script
#
# No model-selection or forecasting logic has been silently corrected here.
# See docs/REPRODUCIBILITY_NOTES.md for issues to revisit during the final pass.
# ============================================================================ #
...
appl_data <- read_excel("data/APPL.xlsx", sheet = "Daily")
